...
public class JianPublishActivity extends BaseActivity implements AdapterView.OnItemClickListener, View.OnClickListener {
    ...
    protected int getLayoutId() {
        return R.layout.activity_jian_publish;
    }
        ...
        public void onPickPhotoFinishListener(File imageFile) {
            if (imageFile != null) {
                if (isPickCover) {
                    ...
                    Picasso.with(JianPublishActivity.this).load(Uri.fromFile(coverImageFile)).resizeDimen(R.dimen.publish_grid_view_size, R.dimen.publish_grid_view_size).centerCrop().into(imageViewCover);
                } else {
