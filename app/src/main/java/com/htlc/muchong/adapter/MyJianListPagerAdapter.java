 ...
 */
public class MyJianListPagerAdapter extends FragmentStatePagerAdapter {
    private ArrayList<MyJianListFragment> mPageFragments;

    public MyJianListPagerAdapter(FragmentManager fm, ArrayList<MyJianListFragment> pageFragments) {
        super(fm);
